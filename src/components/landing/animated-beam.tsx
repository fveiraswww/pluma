...
export function AnimatedBeamMultipleOutputDemo({className}: {className?: string}) {
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "relative flex h-[320px] w-full items-center justify-center overflow-hidden rounded-lg border bg-background p-10 md:shadow-xl",
        className,
      )}
    >
      <div className="flex size-full max-w-lg flex-row items-stretch justify-between gap-10">
        ...
        <div className="flex flex-col justify-center">
          <Circle ref={div6Ref} className="size-16">
            <Image
              alt="OBS Favicon"
              height={24}
              src="https://obsproject.com/favicon.ico"
              width={24}
            />
          </Circle>
        </div>
        <div className="flex flex-col justify-center gap-2">
          <Circle ref={div1Ref}>
            <img alt="Kick Favicon" src="https://kick.com/favicon.ico" />
          </Circle>
          <Circle ref={div2Ref}>
            <img alt="Twitch Favicon" src="https://twitch.com/favicon.ico" />
          </Circle>
          <Circle ref={div3Ref}>
            <img alt="Yt Favicon" src="https://youtube.com/favicon.ico" />
          </Circle>
          <Circle ref={div4Ref}>
            <Icons.messenger />
          </Circle>
      ...
      {/* AnimatedBeams */}
      <AnimatedBeam
        containerRef={containerRef as any as RefObject<HTMLElement>}
        duration={3}
        fromRef={div1Ref as any}
        toRef={div6Ref as any}
      />
      <AnimatedBeam
        containerRef={containerRef as any}
        duration={3}
        fromRef={div2Ref as any}
        toRef={div6Ref as any}
      />
      <AnimatedBeam
        containerRef={containerRef as any}
        duration={3}
        fromRef={div3Ref as any}
        toRef={div6Ref as any}
      />
      <AnimatedBeam
        containerRef={containerRef as any}
        duration={3}
        fromRef={div4Ref as any}
        toRef={div6Ref as any}
      />
      <AnimatedBeam
        containerRef={containerRef as any}
        duration={3}
        fromRef={div5Ref as any}
        toRef={div6Ref as any}
      />
      <AnimatedBeam
        containerRef={containerRef as any}
        duration={3}
        fromRef={div6Ref as any}
        toRef={div7Ref as any}
      />
    </div>
  );
}
